...
parser.add_argument('--clones_BC1', help = '.BC1.clones.csv file') # v7.linBC_matrix.BC2.clones.csv'
...
def get_clone(cellbc, df_bc):
	...
	if cellbc in df_bc.index:
		clone = str(df_bc.loc[cellbc, 'clonal_family'])
	else:
		clone = np.nan
	return clone
